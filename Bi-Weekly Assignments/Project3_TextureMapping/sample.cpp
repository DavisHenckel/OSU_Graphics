...
const char *WINDOWTITLE = { "Assignment 3 -- Davis Henckel" };
...
Display( )
{
	...
	glLoadIdentity( );
	glColor3f( 1., 1., 1. );
	DoRasterString( 5., 5., 0., (char *)"Davis Henckel - Project 3" );
